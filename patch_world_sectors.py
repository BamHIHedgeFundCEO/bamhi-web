...
# We will replace everything from `def plot_chart(df, item):` to the end of the file.
...
old_str = original_code[original_code.find("def plot_chart(df, item):"):]
final_code = original_code.replace(old_str, new_code)

with open(file_path, "w", encoding="utf-8") as f:
    f.write(final_code)
print("Replaced world_sectors.py plot_chart successfully.")
